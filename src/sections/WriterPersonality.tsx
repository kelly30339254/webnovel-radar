...
export default function WriterPersonality() {
  return (
    <section className="mt-10">
      ...
      >
        <div className="flex h-16 w-16 flex-none items-center justify-center rounded-full bg-gradient-to-br from-theme-100 to-theme-200 text-3xl shadow-inner">
          📝
        </div>
        <div className="min-w-0 flex-1">
          <h3 className="text-lg font-bold text-theme-950">测测你的网文十六型人格</h3>
          <p className="mt-1 text-sm text-theme-600">20 道题，测出你到底是爆更狂魔还是万年鸽王</p>
        </div>

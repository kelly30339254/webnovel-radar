...
export default function WriterPersonality() {
  return (
    <section className="mt-10">
      ...
      >
        <div className="flex h-16 w-16 flex-none items-center justify-center rounded-full bg-gradient-to-br from-rose-100 to-pink-100 text-3xl shadow-inner">
          📝
        </div>
        <div className="min-w-0 flex-1">
          <h3 className="text-lg font-bold text-rose-950">测测你的网文十六型人格</h3>
          <p className="mt-1 text-sm text-rose-400">20 道题，测出你到底是爆更狂魔还是万年鸽王</p>
        </div>
        <span className="flex h-8 w-8 flex-none items-center justify-center rounded-full bg-rose-500 text-white shadow-sm">
          <ArrowRight size={16} />
        </span>
      </Link>
    </section>
